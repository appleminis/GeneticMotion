    ...
    vector<int8_t> rv={ 2,8,  2,8,  3,0,1,35,-35,  3,0,2,35,35,  2,10,  3,1,3,55-0,0, 2,12,  4,1,  3,2,-4,60,0,  4,1,  3,2,-4,60,0, 4,1,  3,0,1,15,0,  4,1,  1,127/8,-14,  0};
    ...
    void renderScene() // this function is called when you need to redraw the scene
    {
        ...
        for (int i=0; i<100; i++) cellmanager.dynamicCompute(0.125,0.0125);
